...
class Selector(object):
    """
    The Selector is an object that supervise the selection of hyper parameter of feature transformation and
    model training.
    ...
    def get_classifier(self):
        ...
        return Predictor(self.model, self.fold_manager.data_transformer, d_param_model, d_param_feature)
